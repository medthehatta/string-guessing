...
var $author$project$Main$GotGameState = function (a) {
...
var $author$project$Main$fetchConstantGame = $elm$http$Http$get(
	{
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SampleClicked':
				var sample = msg.a;
				var _v1 = model.selectedSample;
				if (_v1.$ === 'Nothing') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								selectedSample: $elm$core$Maybe$Just(sample)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var sample_ = _v1.a;
					return _Utils_eq(sample_, sample) ? _Utils_Tuple2(
						_Utils_update(
							model,
						...
						return _Utils_update(
							model,
							{
								results: _Utils_ap(
									...
									_List_fromArray(
										[
											_Utils_Tuple3(sample, test, result)
										])),
								selectedSample: $elm$core$Maybe$Nothing
							});
					}();
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Guess the composition of the \'samples\', which are 5-letter strings made of A, B, C, and D')
						]))
				])),
			A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Click the sample you want to test, then the test you want to perform on it.  The answer will appear in the \'Results\' list')
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
...
var $author$project$Main$TestClicked = function (a) {
	return {$: 'TestClicked', a: a};
};
var $author$project$Main$viewTests = function (tests) {
	return A2(
		$elm$html$Html$div,
		$author$project$Main$sectionAttrs,
		_List_fromArray(
...
var $author$project$Main$view = function (model) {
	var showp = model.answersRevealed ? 'hide' : 'reveal';
	var showm = model.answersRevealed ? $author$project$Main$HideAnswers : $author$project$Main$ShowAnswers;
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_Utils_ap(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('(' + (showp + ' answers)'))
						]))
				]),
			_Utils_ap(
				model.answersRevealed ? _List_fromArray(
					[
